...
add_action( 'wpcf7_before_send_mail',
  function( $contact_form, &$abort, $submission ) {
	...
	$args = array(
		'headers' => array(
			'Authorization' => 'Basic ' . base64_encode( 'admin' . ':' . 'test' ),
			'Content-Type' => 'application/json',
		),
		'body' => $json_body,
		);
	
	if ($title != "get-cequr-simplicity-now") {
		$response = wp_remote_post('https://858c8e0d-ad12-4746-8247-98e88522e91c.mock.pstmn.io/post', $args);
